...
export const metadata: Metadata = {
  title: "CPACC 시험 준비",
  description: "IAAP CPACC(Certified Professional in Accessibility Core Competencies) 자격증 시험 정보, 도메인별 학습 가이드, 모의 퀴즈, 플래시카드를 한국어로 제공합니다.",
};

export default async function CpaccPage({
  params,
}: {
